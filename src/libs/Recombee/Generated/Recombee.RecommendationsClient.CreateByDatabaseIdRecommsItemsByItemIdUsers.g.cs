...
namespace Recombee
{
    public partial class RecommendationsClient
    {
        ...
        partial void PrepareCreateByDatabaseIdRecommsItemsByItemIdUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string databaseId,
            string itemId,
            global::Recombee.RecommendUsersToItemParameters request);
        partial void ProcessCreateByDatabaseIdRecommsItemsByItemIdUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateByDatabaseIdRecommsItemsByItemIdUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Recombee.RecommendationResponse> CreateByDatabaseIdRecommsItemsByItemIdUsersAsync(
            string databaseId,
            string itemId,
        ...
        {
            var __response = await CreateByDatabaseIdRecommsItemsByItemIdUsersAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse<global::Recombee.RecommendationResponse>> CreateByDatabaseIdRecommsItemsByItemIdUsersAsResponseAsync(
            string databaseId,
            string itemId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateByDatabaseIdRecommsItemsByItemIdUsersArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateByDatabaseIdRecommsItemsByItemIdUsersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateByDatabaseIdRecommsItemsByItemIdUsersAsync",
                                pathTemplate: "$\"/{databaseId}/recomms/items/{itemId}/users/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateByDatabaseIdRecommsItemsByItemIdUsersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateByDatabaseIdRecommsItemsByItemIdUsersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Recombee.RecommendationResponse> CreateByDatabaseIdRecommsItemsByItemIdUsersAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Recombee.RecommendUsersToItemParameters
            {
                Count = count,
                Scenario = scenario,
            ...
            return await CreateByDatabaseIdRecommsItemsByItemIdUsersAsync(
                databaseId: databaseId,
                itemId: itemId,
                request: __request,
                requestOptions: requestOptions,
