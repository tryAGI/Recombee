...
namespace Recombee
{
    public partial class SeriesClient
    {
        ...
        {
            await CreateByDatabaseIdSeriesBySeriesIdItemsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> CreateByDatabaseIdSeriesBySeriesIdItemsAsResponseAsync(
            string databaseId,
            string seriesId,
