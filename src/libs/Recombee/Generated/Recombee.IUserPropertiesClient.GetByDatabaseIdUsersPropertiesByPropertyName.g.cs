...
namespace Recombee
{
    public partial interface IUserPropertiesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse<global::Recombee.PropertyInfo>> GetByDatabaseIdUsersPropertiesByPropertyNameAsResponseAsync(
            string databaseId,
            string propertyName,
            global::Recombee.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
