...
namespace Recombee
{
    public partial interface IUserItemInteractionsClient
    {
        ...
        global::System.Threading.Tasks.Task DeleteByDatabaseIdBookmarksAsync(
            string databaseId,
            string userId,
            string itemId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> DeleteByDatabaseIdBookmarksAsResponseAsync(
            string databaseId,
            string userId,
            string itemId,
            double? timestamp = default,
