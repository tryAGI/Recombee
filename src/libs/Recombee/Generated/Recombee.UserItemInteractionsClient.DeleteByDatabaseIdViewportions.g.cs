...
namespace Recombee
{
    public partial class UserItemInteractionsClient
    {
        ...
        partial void PrepareDeleteByDatabaseIdViewportionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string itemId,
            string? sessionId);
        partial void ProcessDeleteByDatabaseIdViewportionsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteByDatabaseIdViewportionsAsync(
            string databaseId,
            string userId,
            string itemId,
        ...
        {
            await DeleteByDatabaseIdViewportionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> DeleteByDatabaseIdViewportionsAsResponseAsync(
            string databaseId,
            string userId,
            string itemId,
            string? sessionId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteByDatabaseIdViewportionsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteByDatabaseIdViewportionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteByDatabaseIdViewportions",
                                methodName: "DeleteByDatabaseIdViewportionsAsync",
                                pathTemplate: "$\"/{databaseId}/viewportions/\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteByDatabaseIdViewportionsResponse(
                    httpClient: HttpClient,
