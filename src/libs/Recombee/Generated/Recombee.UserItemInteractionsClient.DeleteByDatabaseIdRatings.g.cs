...
namespace Recombee
{
    public partial class UserItemInteractionsClient
    {
        ...
        partial void PrepareDeleteByDatabaseIdRatingsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string itemId,
            double? timestamp);
        partial void ProcessDeleteByDatabaseIdRatingsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteByDatabaseIdRatingsAsync(
            string databaseId,
            string userId,
            string itemId,
        ...
        {
            await DeleteByDatabaseIdRatingsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> DeleteByDatabaseIdRatingsAsResponseAsync(
            string databaseId,
            string userId,
            string itemId,
            double? timestamp = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteByDatabaseIdRatingsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteByDatabaseIdRatingsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteByDatabaseIdRatings",
                                methodName: "DeleteByDatabaseIdRatingsAsync",
                                pathTemplate: "$\"/{databaseId}/ratings/\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteByDatabaseIdRatingsResponse(
                    httpClient: HttpClient,
