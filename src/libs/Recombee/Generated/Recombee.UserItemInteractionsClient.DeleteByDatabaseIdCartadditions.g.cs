...
namespace Recombee
{
    public partial class UserItemInteractionsClient
    {
        ...
        partial void PrepareDeleteByDatabaseIdCartadditionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string itemId,
            double? timestamp);
        partial void ProcessDeleteByDatabaseIdCartadditionsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteByDatabaseIdCartadditionsAsync(
            string databaseId,
            string userId,
            string itemId,
        ...
        {
            await DeleteByDatabaseIdCartadditionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> DeleteByDatabaseIdCartadditionsAsResponseAsync(
            string databaseId,
            string userId,
            string itemId,
            double? timestamp = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteByDatabaseIdCartadditionsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteByDatabaseIdCartadditionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteByDatabaseIdCartadditions",
                                methodName: "DeleteByDatabaseIdCartadditionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteByDatabaseIdCartadditionsResponse(
                    httpClient: HttpClient,
