...
namespace Recombee
{
    public partial class UserItemInteractionsClient
    {
        ...
        partial void PrepareDeleteByDatabaseIdPurchasesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string itemId,
            double? timestamp);
        partial void ProcessDeleteByDatabaseIdPurchasesResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteByDatabaseIdPurchasesAsync(
            string databaseId,
            string userId,
            string itemId,
        ...
        {
            await DeleteByDatabaseIdPurchasesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> DeleteByDatabaseIdPurchasesAsResponseAsync(
            string databaseId,
            string userId,
            string itemId,
            double? timestamp = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteByDatabaseIdPurchasesArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteByDatabaseIdPurchasesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteByDatabaseIdPurchases",
                                methodName: "DeleteByDatabaseIdPurchasesAsync",
                                pathTemplate: "$\"/{databaseId}/purchases/\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteByDatabaseIdPurchasesResponse(
                    httpClient: HttpClient,
