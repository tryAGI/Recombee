...
namespace Recombee
{
    public partial class RecommendationsClient
    {
        ...
        partial void PrepareCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string databaseId,
            string userId,
            global::Recombee.RecommendItemSegmentsToUserParameters request);
        partial void ProcessCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Recombee.RecommendationResponse> CreateByDatabaseIdRecommsUsersByUserIdItemSegmentsAsync(
            string databaseId,
            string userId,
        ...
        {
            var __response = await CreateByDatabaseIdRecommsUsersByUserIdItemSegmentsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse<global::Recombee.RecommendationResponse>> CreateByDatabaseIdRecommsUsersByUserIdItemSegmentsAsResponseAsync(
            string databaseId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateByDatabaseIdRecommsUsersByUserIdItemSegmentsAsync",
                                pathTemplate: "$\"/{databaseId}/recomms/users/{userId}/item-segments/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateByDatabaseIdRecommsUsersByUserIdItemSegmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Recombee.RecommendationResponse> CreateByDatabaseIdRecommsUsersByUserIdItemSegmentsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Recombee.RecommendItemSegmentsToUserParameters
            {
                Count = count,
                Scenario = scenario,
            ...
            return await CreateByDatabaseIdRecommsUsersByUserIdItemSegmentsAsync(
                databaseId: databaseId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
