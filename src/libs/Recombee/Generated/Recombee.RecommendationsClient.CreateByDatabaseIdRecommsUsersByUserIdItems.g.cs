...
namespace Recombee
{
    public partial class RecommendationsClient
    {
        ...
        {
            var __response = await CreateByDatabaseIdRecommsUsersByUserIdItemsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse<global::Recombee.RecommendationResponse>> CreateByDatabaseIdRecommsUsersByUserIdItemsAsResponseAsync(
            string databaseId,
            string userId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateByDatabaseIdRecommsUsersByUserIdItemsAsync",
                                pathTemplate: "$\"/{databaseId}/recomms/users/{userId}/items/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
