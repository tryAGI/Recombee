...
namespace Recombee
{
    public partial class RecommendationsClient
    {
        ...
        {
            var __response = await CreateByDatabaseIdRecommsNextItemsByRecommIdAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse<global::Recombee.RecommendationResponse>> CreateByDatabaseIdRecommsNextItemsByRecommIdAsResponseAsync(
            string databaseId,
            string recommId,
