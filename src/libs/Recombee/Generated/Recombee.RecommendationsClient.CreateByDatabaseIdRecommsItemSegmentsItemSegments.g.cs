...
namespace Recombee
{
    public partial class RecommendationsClient
    {
        ...
        partial void PrepareCreateByDatabaseIdRecommsItemSegmentsItemSegmentsArguments(
            ...
            global::Recombee.RecommendItemSegmentsToItemSegmentParameters request);
        partial void PrepareCreateByDatabaseIdRecommsItemSegmentsItemSegmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string databaseId,
            global::Recombee.RecommendItemSegmentsToItemSegmentParameters request);
        partial void ProcessCreateByDatabaseIdRecommsItemSegmentsItemSegmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateByDatabaseIdRecommsItemSegmentsItemSegmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Recommend Item Segments to Item Segment<br/>
        /// Recommends Segments from a result [Segmentation](https://docs.recombee.com/segmentations) that are the most relevant to a particular Segment from a context Segmentation.<br/>
        /// Based on the used Segmentations, this endpoint can be used for example for:<br/>
        ///   - Recommending the related brands to particular brand<br/>
        ///   - Recommending the related brands to particular category<br/>
        ///   - Recommending the related artists to a particular genre (assuming songs are the Items)<br/>
        /// You need to set the used context and result Segmentation the Admin UI in the [Scenario settings](https://docs.recombee.com/scenarios) prior to using this endpoint.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Recombee.RecommendationResponse> CreateByDatabaseIdRecommsItemSegmentsItemSegmentsAsync(
            string databaseId,
        ...
        {
            var __response = await CreateByDatabaseIdRecommsItemSegmentsItemSegmentsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse<global::Recombee.RecommendationResponse>> CreateByDatabaseIdRecommsItemSegmentsItemSegmentsAsResponseAsync(
            string databaseId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateByDatabaseIdRecommsItemSegmentsItemSegmentsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateByDatabaseIdRecommsItemSegmentsItemSegmentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateByDatabaseIdRecommsItemSegmentsItemSegmentsAsync",
                                pathTemplate: "$\"/{databaseId}/recomms/item-segments/item-segments/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateByDatabaseIdRecommsItemSegmentsItemSegmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateByDatabaseIdRecommsItemSegmentsItemSegmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateByDatabaseIdRecommsItemSegmentsItemSegmentsAsync(
                databaseId: databaseId,
                request: __request,
                requestOptions: requestOptions,
