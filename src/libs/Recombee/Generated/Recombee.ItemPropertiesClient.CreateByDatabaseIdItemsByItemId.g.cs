...
namespace Recombee
{
    public partial class ItemPropertiesClient
    {
        ...
        partial void PrepareCreateByDatabaseIdItemsByItemIdArguments(
            ...
            string request);
        partial void PrepareCreateByDatabaseIdItemsByItemIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? cascadeCreate,
            string request);
        partial void ProcessCreateByDatabaseIdItemsByItemIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateByDatabaseIdItemsByItemIdAsync(
            string databaseId,
            string itemId,
        ...
        {
            await CreateByDatabaseIdItemsByItemIdAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> CreateByDatabaseIdItemsByItemIdAsResponseAsync(
            string databaseId,
            string itemId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateByDatabaseIdItemsByItemIdArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateByDatabaseIdItemsByItemIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createByDatabaseIdItemsByItemId",
                                methodName: "CreateByDatabaseIdItemsByItemIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateByDatabaseIdItemsByItemIdResponse(
                    httpClient: HttpClient,
