...
namespace Recombee
{
    public partial class UserItemInteractionsClient
    {
        ...
        partial void PrepareDeleteByDatabaseIdBookmarksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string itemId,
            double? timestamp);
        partial void ProcessDeleteByDatabaseIdBookmarksResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteByDatabaseIdBookmarksAsync(
            string databaseId,
            string userId,
            string itemId,
        ...
        {
            await DeleteByDatabaseIdBookmarksAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recombee.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recombee.AutoSDKHttpResponse> DeleteByDatabaseIdBookmarksAsResponseAsync(
            string databaseId,
            string userId,
            string itemId,
            double? timestamp = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteByDatabaseIdBookmarksArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteByDatabaseIdBookmarksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recombee.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recombee.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteByDatabaseIdBookmarks",
                                methodName: "DeleteByDatabaseIdBookmarksAsync",
                                pathTemplate: "$\"/{databaseId}/bookmarks/\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteByDatabaseIdBookmarksResponse(
                    httpClient: HttpClient,
